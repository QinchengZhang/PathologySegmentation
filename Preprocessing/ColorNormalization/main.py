...
if op == 0:
    filename = "G:\TJUZQC\code\python\Color_Normalisation_code\warwick_target_p.png"
    ...
    run_colornorm(source_filename, target_filename, nstains, lamb,
                  output_direc, level, background_correction, config=config)
